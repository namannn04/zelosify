export default function Billing() {
  return (
    <div className="px-3 py-4 max-w-3xl">
      <h2 className="text-xl font-bold text-foreground mb-8">Billing</h2>

      {/* Current Plan Section */}
      <div className="mb-12 bg-tableHeader p-6 rounded-lg border border-dotted border-border">
        <h3 className="text-lg font-medium mb-4">Current Plan</h3>
        <div className="flex justify-between items-center">
          <div>
            <p className="text-2xl font-bold">Pro Plan</p>
            <p className="text-sm text-secondary">Billed annually</p>
          </div>
          <button className="px-2 py-1 bg-foreground text-background rounded-md transition-colors">
            Upgrade Plan
          </button>
        </div>
        <div className="mt-4 p-4 bg-border rounded-md">
