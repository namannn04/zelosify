...
export default function TestimonialsSection() {
    ...
    return (
        <div className="bg-gradient-to-b from-[#0F0720] to-[#0A051A] py-20 px-4 sm:px-6 lg:px-8 overflow-hidden" id="testimonials">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-purple-200 max-w-3xl mx-auto text-lg">
                        Discover how our AI writing tool has transformed the writing experience for users worldwide,
                        making it more efficient, accurate, and enjoyable.
                    </p>
                </div>
                                ...
                                >
                                    <div className="flex items-center mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-purple-300">{testimonial.username}</p>
                                    ...
                                    <div className="relative">
                                        <Quote size={24} className="absolute top-0 left-0 text-purple-500/20 transform -translate-x-2 -translate-y-2" />
                                        <p className="text-purple-200 pl-6">
                                            {testimonial.text}
                                        </p>
                                    </div>
                                </div>
