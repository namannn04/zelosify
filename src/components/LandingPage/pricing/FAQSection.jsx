  ...
  const faqs = [
    {
      ...
      answer:
        "Zelosify is a vendor contract management software designed to maximize the value of your vendor agreements.",
    },
    {
      question: "What does Zelosify provide?",
      answer:
        "It offers tools to manage contracts, gain insights, prevent revenue leaks, and ensure vendor compliance",
    },
    {
      question: "Is my data safe with Zelosify?",
      answer:
        "Yes, Zelosify is fully GDPR-compliant and prioritizes data security for our clients.",
    },
    {
      question: "Can Zelosify handle large contract portfolios?",
      answer:
        "Absolutely, it is built to manage and organize extensive vendor and contract data effortlessly.",
    },
    {
      question: "How does Zelosify prevent revenue losses?",
      answer:
        "It identifies missed penalties, flags non-compliance, and provides actionable insights to protect your revenue.",
    },
    {
      question: "Is ZELOSIFY available for purchase",
      answer:
        "ZELOSIFY is currently available only to private beta users. To know more about it, contact support@ZELOSIFY.COM.",
    },
  ];
