...
import { ChevronDown, HelpCircle, DollarSign, CreditCard, FileText, Clock, Mail, Phone, Sparkles, Shield } from "lucide-react"
  ...
  return (
    <section className="py-16 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        ...
        {/* Enhanced Bottom CTA */}
        <div className="text-center mt-12 opacity-0 animate-[fadeInUp_0.6s_ease-out_1s_forwards]">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600 mb-6">
                Our team is here to help you get started with Zelosify
              </p>
              <div className="flex justify-center space-x-4">
                <Link
                  href="/contact"
                  className="group/btn inline-flex items-center px-6 py-3 bg-gradient-to-r from-gray-900 to-gray-700 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-0.5"
                >
