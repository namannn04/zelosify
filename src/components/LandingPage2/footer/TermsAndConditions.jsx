        ...
        <div className="prose prose-invert prose-purple max-w-none">
          <div className="bg-[#1A1033] rounded-xl p-8 mb-8">
            ...
            <p className="text-purple-200 mb-4">
              We are Zelosify Pvt Ltd ("Company", "we", "us", "our"), a company
              registered in India at [bangalore].
            </p>
            <p className="text-purple-200 mb-4">
            ...
            <p className="text-purple-200 mb-4">
              You can contact us by email at support@zelosify.com or by mail to
              [Bangalore].
            </p>
            <p className="text-purple-200 mb-4">
              These Legal Terms constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity ("you"),
              and Zelosify Pvt Ltd, concerning your access to and use of the
              Services. By accessing the Services, you confirm that you have
              read, understood, and agreed to be bound by these Legal Terms.
            </p>
            <p className="text-white mb-4 font-bold">
          ...
          <section id="section-1" className="mb-12 scroll-mt-80">
            ...
            <p className="text-purple-200 mt-4">
              ...
              etc.), so if your interactions would be subject to such laws, you
              may not use the Services. You may not use the Services in a way
          ...
          <section id="section-2" className="mb-12 scroll-mt-80">
            ...
            <ul className="space-y-2 text-purple-200 mt-6">
              ...
              <li>
                ...
                which you have properly gained access, solely for your internal
                business purpose.
              </li>
            </ul>
            <p className="text-purple-200 mt-4">
            ...
            <p className="text-purple-200 mt-4">
              ...
              Terms, please address your request to: support@zelosify.com. If we
              ever grant you permission to post, reproduce, or publicly display
            ...
            <h3 className="text-xl font-bold text-white mt-8">Contributions</h3>
            <p className="text-purple-200 mt-4">
              By directly sending us any question, comment, suggestion, idea,
              feedback, or other information about the Services ("Submissions"),
              you agree to assign to us all intellectual property rights in such
            ...
            <p className="text-purple-200 mt-4">
              ...
              and through any media channels. This license includes your use of
          ...
          <section id="section-5" className="mb-12 scroll-mt-80">
            ...
            <p className="text-purple-200 mt-4">
              ...
              the same billing or shipping address. We also reserve the right to
          ...
          <section id="section-6" className="mb-12 scroll-mt-80">
            ...
            <h3 className="text-xl font-bold text-white mt-8">Cancellation</h3>
            <p className="text-purple-200 mt-4">
          ...
          <section id="section-8" className="mb-12 scroll-mt-80">
            ...
            <p className="text-purple-200 mt-4">
              ...
              Services and access Third-Party Websites or to use or install any
          ...
          <section id="section-11" className="mb-12 scroll-mt-80">
            ...
            <p className="text-purple-200 mt-4">
              ...
              advised that pursuant to applicable law, you may be held liable
              for damages if you make material misrepresentations in a
          ...
          <section id="section-15" className="mb-12 scroll-mt-80">
            ...
            <p className="text-purple-200 mt-4">
              ...
              you and we agree to first attempt to negotiate any Dispute (except
              those expressly provided below) informally for at least 30 days
            ...
            <p className="text-purple-200 mt-4">
              ...
              shall be finally resolved by the International Commercial
            ...
            <h3 className="text-xl font-bold text-white mt-8">Restrictions</h3>
            <p className="text-purple-200 mt-4">
            ...
            <ul className="list-disc pl-6 space-y-2 text-purple-200 mt-6">
              ...
              <li>
                There is no right or authority for any Dispute to be arbitrated
                on a class-action basis.
              </li>
              <li>
                There is no right or authority for any Dispute to be brought in
                a purported representative capacity on behalf of the public or
                any other persons.
              </li>
            </ul>
