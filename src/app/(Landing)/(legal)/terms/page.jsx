        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose max-w-none">
            ...
            <section id="section-2" className="mb-12 scroll-mt-80">
              ...
              <h3 className="text-xl font-bold text-black mt-8">Submissions</h3>
              <p className="text-gray-700 mt-4">
              ...
              <ul className="space-y-2 text-gray-700 mt-6 list-disc pl-6">
                <li>
            ...
            <section id="section-6" className="mb-12 scroll-mt-80">
              ...
              <h3 className="text-xl font-bold text-black mt-8">Free Trial</h3>
              <p className="text-gray-700 mt-4">
            ...
            <section id="section-15" className="mb-12 scroll-mt-80">
              ...
              <ul className="list-decimal pl-6 space-y-2 text-gray-700 mt-6">
                <li>
          ...
          <div id="contact" className="bg-gray-50 rounded-xl p-8 mt-12">
